...
export default function TopBar() {
    return (    <Disclosure as="nav" className="relative bg-white shadow-sm">
      ...
      <DisclosurePanel className="sm:hidden">
        ...
        <div className="border-t border-gray-200 pt-4 pb-3">
          <div className="flex items-center px-4">
            ...
            <div className="ml-3">
              <div className="text-base font-medium text-gray-800">Dark Vader</div>
              <div className="text-sm font-medium text-gray-500">darth_vader@empire.com</div>
            </div>
          </div>
