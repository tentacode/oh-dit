...
namespace App\ThirdParty\Raweb\Console;
...
#[AsCommand(name: 'raweb:import', description: 'Import RAWEB 1.1 as a RuleSet.')]
class ImportRawebConsole extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $symfonyStyle->title('Importing RAWEB 1.1 from json files');

        $criteriaFilePath = $this->projectDirectory . '/var/data/raweb-git/fr/json/criteres.json';
        ...
        $symfonyStyle->success('RAWEB 1.1 imported successfully.');
    ...
    {
        $ruleSet = new RuleSet(
            name: RuleSet::RAWEB_NAME,
            description: 'Référentiel d\'Évaluation de l\'Accessibilité Web',
            version: '1.1',
        );
