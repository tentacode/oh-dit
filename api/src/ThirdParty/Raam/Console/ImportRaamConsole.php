...
namespace App\ThirdParty\Raam\Console;
...
#[AsCommand(name: 'raam:import', description: 'Import RAAM 1.1 as a RuleSet.')]
class ImportRaamConsole extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $symfonyStyle->title('Importing RAAM 1.1 from json files');

        $criteriaFilePath = $this->projectDirectory . '/var/data/raam-git/fr/json/criteres.json';
        ...
        $symfonyStyle->success('RAAM 1.1 imported successfully.');
    ...
    {
        $ruleSet = new RuleSet(
            name: RuleSet::RAAM_NAME,
            description: 'Référentiel d’évaluation de l’accessibilité des applications mobiles (RAAM)',
            version: '1.1',
        );
