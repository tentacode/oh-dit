...
pageTitle: Politique de sécurisation des données - Ohdit
metaDescription: ""
---
...
Nous avons essayé d'écrire cette politique de sécurisation des données de la manière la plus claire et compréhensible possible mais nous restons disponibles pour répondre à vos questions sur le sujet. N'hésitez pas à nous envoyer un message à [data@ohdit.com](mailto:data@ohdit.com) pour en discuter.
...
Cette demande peut être faite directement à [data@ohdit.com](mailto:data@ohdit.com).
